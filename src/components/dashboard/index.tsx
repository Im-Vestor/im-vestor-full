...
export default function Dashboard() {
  ...
  const hasNews = firstNewsArticle && 'type' in firstNewsArticle && firstNewsArticle.type === 'child_page';
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-xl border-2 border-white/10 bg-card p-12">
        <div className="text-center">
          <h2 className="text-4xl text-white/20 leading-tight flex items-center justify-center gap-2">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/news" className="flex items-center gap-2 text-white/70 hover:text-[#EFD687] transition-colors">
            <span>View All</span>
        ...
        <Link href="/support">
          <div className="rounded-xl border-2 border-white/10 bg-card p-6 transition-all hover:border-white/20 cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-white">Need Help? <span className="text-sm text-white/60">help@im-vestor.com</span></div>
              </div>
            </div>
          </div>
        </Link>
