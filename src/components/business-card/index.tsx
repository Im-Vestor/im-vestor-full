          ...
          >
            <div
              className={cn(
                ...
                selectedTemplate === 1
                  ? 'bg-gradient-to-r from-[#111111] to-[#222222]'
                  : 'bg-gradient-to-r from-[#131335] to-[#1f203e]'
              )}
            >
              <Image
          ...
          >
            <div
              className={cn(
                ...
                selectedTemplate === 1
                  ? 'bg-gradient-to-r from-[#151515] to-[#252525]'
                  : 'bg-gradient-to-r from-[#23243e] to-[#343560]'
              )}
            >
