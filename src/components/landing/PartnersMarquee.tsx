...
export default function PartnersMarquee() {
  ...
  if (!isLoadingPartners && (!partners || partners.length < 3)) return null;
                    ...
                    ? partners.map(partner => {
                        ...
                        return (
                          <div
                            key={partner.id}
                            onClick={handleClick}
                            className={`flex items-center justify-center w-24 h-12 sm:w-32 sm:h-16 md:w-40 md:h-20 rounded-lg sm:rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 transition-all duration-300 group ${
