...
export function PartnersSection({ variant = 'landing' }: PartnersSectionProps) {
  ...
  const containerClasses = isInternal ? 'relative w-full py-8' : 'relative w-full py-8';
  ...
  return (
    ...
    >
      <div className="relative z-10">
        <h2 className={titleClasses}>{t('trustedByPartners')}</h2>
        <motion.p variants={fadeIn} className={descriptionClasses}>
